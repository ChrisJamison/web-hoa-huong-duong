...
namespace WebHoaHuongDuong.WssDataFeed
{
    [Serializable]
    //[DataContract]
    [XmlRoot("Product")]
    public class Product
    {
        ...
        [XmlIgnore]
        //[DataMember]
        public string VatStatus { get; set; }//NOT
        [XmlElement("vat_status")]//Thời gian giao hàng
        public System.Xml.XmlCDataSection VatStatusCDATA
        {
            get
            {
                return new System.Xml.XmlDocument().CreateCDataSection(VatStatus);
            }
            set
            {
                VatStatus = value.Value;
            }
        }
        public Product()
        {
